        ...
        else
        {
            ...
            $(".plat").each(function(){
                if($(this).val() != "")
                {
                    ...
                    var accompagnement = $(this).parent().parent().parent().parent().find(".accompagnement") ;
                    ...
                    if(enregitre)
                    {
                        accompagnement.each(function(){
                            if($(this).val() != "")
                            {
                                var portion_accompagnement = $(this).parent().parent().parent().parent().find(".portion_accompagnement") ;
                                enregistre = false
